        ...
        (async () => {
            try {
                ...
                wx.config({
                    ...
                    jsApiList: ['onMenuShareTimeline', 'onMenuShareTimeline'] // 必填，需要使用的JS接口列表，所有JS接口列表见附录2
                });

                wx.ready(() => {
                    wx.onMenuShareTimeline({
                        title: '分享到朋友圈', // 分享标题
                        link: `http://www.chickenfarm.com.cn/weixin/cultivation/toFarms.html?referrer=${openId}`, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
                        imgUrl: '', // 分享图标
